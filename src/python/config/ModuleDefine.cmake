...
function(PYIMATH_DEFINE_MODULE modname)
  ...
  if(USE_PYTHON2)
    ...
    if(TARGET Python3::Python)
      ...
      message(STATUS "target_link_libraries(${modname}_python3 PRIVATE ${libname} ${extraDeps} ${PYIMATH_CURMOD_DEPENDENCIES} ${PYIMATH_CURMOD_PRIVATE_DEPS} $<TARGET_NAME_IF_EXISTS:Boost::${PYIMATH_BOOST_PY_COMPONENT}> )")
